...
class Personal implements ISettings
{
    ...
    public function getForm(): TemplateResponse
    {
        ...
        $defaultAutomaticActivation = $this->config->getAppValue($this->appName, 'theme_automatic_activation_enabled', "1");
        $themeEnabled = $this->config->getUserValue($this->userId, $this->appName, 'theme_enabled', $default);
        $themeAutomaticActivation = $this->config->getUserValue($this->userId, $this->appName, 'theme_automatic_activation_enabled', $default);
