OC.L10N.register(
    ...
    "This setting will enable the automated activation by the clients system settings by default, for any unauthenticated users and users who haven't set a preference." : "Esta configuração habilitará a ativação automatizada pelas configurações do sistema do cliente por padrão, para todos os usuários não autenticados e usuários que não definiram uma preferência.",
