OC.L10N.register(
    ...
    "This setting will enable the automated activation by the clients system settings by default, for any unauthenticated users and users who haven't set a preference." : "对于任何未经身份验证的用户和没有设置首选项的用户，该设置将默认启用客户端系统设置的自动激活。",
