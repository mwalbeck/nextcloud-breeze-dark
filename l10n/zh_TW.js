OC.L10N.register(
    ...
    "This setting will enable the automated activation by the clients system settings by default, for any unauthenticated users and users who haven't set a preference." : "預設情況下，此設定會為任何未經身份驗證的使用者與未設定偏好的使用者啟用客戶端系統設定自動啟用。",
