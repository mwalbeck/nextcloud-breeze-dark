OC.L10N.register(
    ...
    "This setting will enable the theme by default, for any unauthenticated users and users who have not set a preference." : "Bu seçenek, kimliğini doğrulamamış konuklar ve bir ayar yapmamış kullanıcılar için temayı varsayılan olarak ayarlar. ",
    "Enable Breeze Dark theme by default" : "Breeze Dark temasını varsayılan olarak ayarla",
    "This setting will enable the automated activation by the clients system settings by default, for any unauthenticated users and users who have not set a preference." : "Bu seçenek, kimliğini doğrulamamış konuklar ve bir ayar yapmamış kullanıcılar için varsayılan olarak istemcinin sistem ayarlarına göre otomatik etkinleştirmeyi kullanır. ",
    "Enable Breeze Dark automated activation by the clients system settings by default" : "Varsayılan olarak istemcinin sistem ayarlarına göre Breeze Dark otomatik etkinleştirmesi kullanılsın",
