OC.L10N.register(
    ...
    "This setting will enable the theme by default, for any unauthenticated users and users who have not set a preference." : "此設定預設將會為所有未經身份驗證的使用者，以及未設定偏好設定的使用者啟用佈景主題。",
    "Enable Breeze Dark theme by default" : "默認情況下啟用 Breeze Dark 主題",
    "This setting will enable the automated activation by the clients system settings by default, for any unauthenticated users and users who have not set a preference." : "默認情況下，此設定會為任何未經身份驗證的用戶與未設定偏好的用戶啟用客戶端系統設定自動啟用。",
