OC.L10N.register(
    ...
    "This setting will enforce the usage of this theme. Please note, this will prevent users from disabling or choosing a different theme." : "此設置將強制使用此主題。 請注意，這將防止用戶停用或選擇不同的主題。",
    "Enforce use of the Breeze Dark theme" : "強制使用 Breeze Dark 主題",
    ...
    "This setting will allow you to choose if the login page should be themed. This only has an effect if the theme is enforced or during the login process for a user that has the theme enabled." : "此設置將允許您選擇登錄頁面是否有主題。這只會在強制執行主題或在登錄期間啟用主題的用戶時生效。",
