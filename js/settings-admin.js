...
window.addEventListener("DOMContentLoaded", function () {
    $("#breezedark-theme-enabled").change(function () {
        $.post(OC.generateUrl("apps/breezedark/settings/admin"), {
            ...
            postSuccess("label[for='breezedark-theme-enabled']", "breezedark-theme-enabled-msg");
        }).fail(function() {
    ...
    $("#breezedark-theme-login-page").change(function () {
        $.post(OC.generateUrl("apps/breezedark/settings/admin"), {
            ...
            postSuccess("label[for='breezedark-theme-login-page']", "breezedark-theme-login-page-msg");
        }).fail(function() {
            postError("label[for='breezedark-theme-login-page']", "breezedark-theme-login-page-msg");
        });
    });
    ...
    $("#breezedark-theme-custom-styling-button").click(function () {
        $.post(OC.generateUrl("apps/breezedark/settings/custom-styling"), {
            ...
            postSuccess("#breezedark-theme-custom-styling-button", "breezedark-theme-custom-styling-button-msg");
        }).fail(function() {
            postError("#breezedark-theme-custom-styling-button", "breezedark-theme-custom-styling-button-msg");
        });
    });
});
